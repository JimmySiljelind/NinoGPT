   ...
   const handleDeleteProjectClick = (project: ChatProject) => {
      void (async () => {
         const confirmed = await requestConfirm({
            ...
            description: `Delete the project "${project.name}" and all chats saved inside it? This action cannot be undone.`,
         ...
         await Promise.resolve(onDeleteProject(project.id));
      })();
   };
                  ...
                  <DropdownMenuItem
                     ...
                     onSelect={(event) => {
                        ...
                        void (async () => {
                           const confirmed = await requestConfirm({
                              title: 'Delete chat?',
                              description: `Delete "${conversation.title}" and all messages? This action cannot be undone.`,
